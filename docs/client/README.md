...
| **Upgrades in place** | A v3.8.x journal opens straight into v3.9.0 — three database upgrades are applied on first launch, and as always the app writes a backup of your database before applying any of them. |
