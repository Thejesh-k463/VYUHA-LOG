...
| **Market Atlas — the market your book is sitting in** | A new screen (Positions → **Market Atlas**) computes breadth from the end-of-day bars **already on your machine**: advancing, declining and unchanged with their denominators; how much of the market is above its 20, 50 and 200-day averages, with a 90-session spark for each; new 52-week highs and lows; median volume expansion. Then the same window by sector and by cap band — bucketed by NSE's own index membership, not by a market cap Vyuha would have to guess at — and your own open equity names against the median return of their industry cohort — falling up to the sector when the industry is too thin, the row saying which — over a week and a month. A Coverage tab holds the ledger: what was excluded and why, the denominator behind every metric, and which symbols are stale. It adds no account, no upload and no new connection, and a copy without Pro sees the screen described rather than hidden — with em-dashes where the figures would be, because sample numbers on a screen about denominators would be the wrong way to sell it. |
