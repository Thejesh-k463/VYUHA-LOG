...
Vyuha version (the installer filename carries it in full — `Vyuha_3.7.1_x64-setup.exe` — and Windows **Settings → Apps → Installed apps** lists it; the sidebar footer shows the release line, `Local · Offline · v3.7`) and, if the
