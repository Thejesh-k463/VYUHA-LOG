...
const KEYWORDS: Record<string, string> = {
  ...
  "/import": "csv xlsx upload broker file map columns zerodha dhan groww angel one angelone upstox kotak neo kotakneo paytm money sahi",
  ...
  "/reports/broker-compare": "broker cost switch mtf zerodha dhan groww angel one angelone upstox kotak neo kotakneo paytm money sahi",
  ...
  "/arjuns-eye": "arjuns eye cockpit behaviour time of day session tilt streak sizing",
