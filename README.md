...
[![Tests](https://img.shields.io/badge/tests-8729%20passing-2ea44f)](tests)
...
tests/       8729 unit + integration tests across 417 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (8729 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 8729 Vitest unit + integration tests (+ tests/load)
```
