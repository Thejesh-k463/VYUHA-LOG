...
[![Tests](https://img.shields.io/badge/tests-5005%20passing-2ea44f)](tests)
...
tests/       5005 unit + integration tests across 268 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (5005 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 5005 Vitest unit + integration tests (+ tests/load)
```
