...
[![Tests](https://img.shields.io/badge/tests-4515%20passing-2ea44f)](tests)
...
tests/       4515 unit + integration tests across 254 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (4515 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 4515 Vitest unit + integration tests (+ tests/load)
```
