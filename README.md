...
[![Tests](https://img.shields.io/badge/tests-11791%20passing-2ea44f)](tests)
...
tests/       11791 unit + integration tests across 499 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (11791 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 11791 Vitest unit + integration tests (+ tests/load)
```
