...
[![Tests](https://img.shields.io/badge/tests-7005%20passing-2ea44f)](tests)
...
tests/       7005 unit + integration tests across 361 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7005 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7005 Vitest unit + integration tests (+ tests/load)
```
