...
[![Tests](https://img.shields.io/badge/tests-9323%20passing-2ea44f)](tests)
...
tests/       9323 unit + integration tests across 427 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (9323 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 9323 Vitest unit + integration tests (+ tests/load)
```
