...
[![Tests](https://img.shields.io/badge/tests-9410%20passing-2ea44f)](tests)
...
tests/       9410 unit + integration tests across 430 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (9410 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 9410 Vitest unit + integration tests (+ tests/load)
```
