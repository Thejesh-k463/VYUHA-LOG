...
[![Tests](https://img.shields.io/badge/tests-7646%20passing-2ea44f)](tests)
...
**Pro — Annual ₹7,999/yr · Journal — Lifetime ₹29,999**, launch prices (list ₹13,000/yr and
...
tests/       7646 unit + integration tests across 378 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7646 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7646 Vitest unit + integration tests (+ tests/load)
```
