...
[![Tests](https://img.shields.io/badge/tests-7742%20passing-2ea44f)](tests)
...
tests/       7742 unit + integration tests across 381 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7742 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7742 Vitest unit + integration tests (+ tests/load)
```
