...
[![Tests](https://img.shields.io/badge/tests-8278%20passing-2ea44f)](tests)
...
tests/       8278 unit + integration tests across 391 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (8278 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 8278 Vitest unit + integration tests (+ tests/load)
```
