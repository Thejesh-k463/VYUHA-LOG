...
[![Tests](https://img.shields.io/badge/tests-7666%20passing-2ea44f)](tests)
...
tests/       7666 unit + integration tests across 379 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7666 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7666 Vitest unit + integration tests (+ tests/load)
```
