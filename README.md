...
[![Tests](https://img.shields.io/badge/tests-4115%20passing-2ea44f)](tests)
...
tests/       4115 unit + integration tests across 239 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (4,115 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 4115 Vitest unit + integration tests (+ tests/load)
```
