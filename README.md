...
[![Tests](https://img.shields.io/badge/tests-2089%20passing-2ea44f)](tests)
...
tests/       2089 unit + integration tests across 140 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (2,089 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 2089 Vitest unit + integration tests (+ tests/load)
```
