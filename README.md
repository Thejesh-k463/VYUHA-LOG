...
[![Tests](https://img.shields.io/badge/tests-7897%20passing-2ea44f)](tests)
...
tests/       7897 unit + integration tests across 384 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7897 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7897 Vitest unit + integration tests (+ tests/load)
```
