...
[![Tests](https://img.shields.io/badge/tests-1921%20passing-2ea44f)](tests)
...
tests/       1921 unit + integration tests across 131 files (+ tests/load: 14 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (1,921 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 1921 Vitest unit + integration tests (+ tests/load)
```
