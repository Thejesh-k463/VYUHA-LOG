...
[![Tests](https://img.shields.io/badge/tests-2602%20passing-2ea44f)](tests)
...
tests/       2602 unit + integration tests across 171 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (2,602 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 2602 Vitest unit + integration tests (+ tests/load)
```
