...
[![Tests](https://img.shields.io/badge/tests-9689%20passing-2ea44f)](tests)
...
tests/       9689 unit + integration tests across 439 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (9689 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 9689 Vitest unit + integration tests (+ tests/load)
```
