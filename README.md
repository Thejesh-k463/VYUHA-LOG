...
[![Tests](https://img.shields.io/badge/tests-2136%20passing-2ea44f)](tests)
...
tests/       2136 unit + integration tests across 143 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (2,136 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 2136 Vitest unit + integration tests (+ tests/load)
```
