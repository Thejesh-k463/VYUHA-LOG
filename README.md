...
[![Tests](https://img.shields.io/badge/tests-6334%20passing-2ea44f)](tests)
...
> **weekend**; exchange holidays are not modelled in this version. Already-marked
...
tests/       6334 unit + integration tests across 339 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (6334 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 6334 Vitest unit + integration tests (+ tests/load)
```
