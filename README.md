...
[![Tests](https://img.shields.io/badge/tests-7704%20passing-2ea44f)](tests)
...
tests/       7704 unit + integration tests across 379 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7704 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7704 Vitest unit + integration tests (+ tests/load)
```
