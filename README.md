...
[![Tests](https://img.shields.io/badge/tests-7661%20passing-2ea44f)](tests)
...
tests/       7661 unit + integration tests across 379 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7661 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7661 Vitest unit + integration tests (+ tests/load)
```
