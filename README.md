...
[![Tests](https://img.shields.io/badge/tests-7634%20passing-2ea44f)](tests)
...
tests/       7634 unit + integration tests across 378 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7634 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7634 Vitest unit + integration tests (+ tests/load)
```
