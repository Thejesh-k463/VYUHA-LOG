...
[![Tests](https://img.shields.io/badge/tests-2104%20passing-2ea44f)](tests)
...
tests/       2104 unit + integration tests across 142 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (2,104 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 2104 Vitest unit + integration tests (+ tests/load)
```
