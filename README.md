...
[![Tests](https://img.shields.io/badge/tests-8835%20passing-2ea44f)](tests)
...
tests/       8835 unit + integration tests across 422 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (8835 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 8835 Vitest unit + integration tests (+ tests/load)
```
