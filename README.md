...
[![Tests](https://img.shields.io/badge/tests-9616%20passing-2ea44f)](tests)
...
tests/       9616 unit + integration tests across 435 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (9616 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 9616 Vitest unit + integration tests (+ tests/load)
```
