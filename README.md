...
[![Tests](https://img.shields.io/badge/tests-9522%20passing-2ea44f)](tests)
...
tests/       9522 unit + integration tests across 433 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (9522 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 9522 Vitest unit + integration tests (+ tests/load)
```
