...
[![Tests](https://img.shields.io/badge/tests-6025%20passing-2ea44f)](tests)
...
tests/       6025 unit + integration tests across 328 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (6025 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 6025 Vitest unit + integration tests (+ tests/load)
```
