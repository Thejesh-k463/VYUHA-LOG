...
[![Tests](https://img.shields.io/badge/tests-9218%20passing-2ea44f)](tests)
...
tests/       9218 unit + integration tests across 426 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (9218 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 9218 Vitest unit + integration tests (+ tests/load)
```
