...
[![Tests](https://img.shields.io/badge/tests-6969%20passing-2ea44f)](tests)
...
> **nothing for you to click**, and a refused sign-in is tried at most three
> times before Vyuha stops until you re-save the credentials. If Angel One
...
tests/       6969 unit + integration tests across 360 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (6969 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 6969 Vitest unit + integration tests (+ tests/load)
```
