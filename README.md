...
[![Tests](https://img.shields.io/badge/tests-7871%20passing-2ea44f)](tests)
...
tests/       7871 unit + integration tests across 382 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7871 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7871 Vitest unit + integration tests (+ tests/load)
```
