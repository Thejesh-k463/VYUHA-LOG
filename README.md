...
[![Tests](https://img.shields.io/badge/tests-2266%20passing-2ea44f)](tests)
...
tests/       2266 unit + integration tests across 151 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (2,266 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 2266 Vitest unit + integration tests (+ tests/load)
```
