...
[![Tests](https://img.shields.io/badge/tests-6055%20passing-2ea44f)](tests)
...
tests/       6055 unit + integration tests across 328 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (6055 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 6055 Vitest unit + integration tests (+ tests/load)
```
