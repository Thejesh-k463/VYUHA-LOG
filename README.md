...
[![Tests](https://img.shields.io/badge/tests-7641%20passing-2ea44f)](tests)
...
tests/       7641 unit + integration tests across 378 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7641 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7641 Vitest unit + integration tests (+ tests/load)
```
