...
[![Tests](https://img.shields.io/badge/tests-1932%20passing-2ea44f)](tests)
...
tests/       1932 unit + integration tests across 132 files (+ tests/load: 14 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (1,932 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 1932 Vitest unit + integration tests (+ tests/load)
```
