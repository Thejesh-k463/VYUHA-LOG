...
[![Tests](https://img.shields.io/badge/tests-2050%20passing-2ea44f)](tests)
...
> **Now: v3.0.0** — full history in [CHANGELOG.md](CHANGELOG.md). Landing page: https://thejesh-k463.github.io/VYUHA-LOG/
>
...
tests/       2050 unit + integration tests across 137 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (2,050 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 2050 Vitest unit + integration tests (+ tests/load)
```
