...
[![Tests](https://img.shields.io/badge/tests-2070%20passing-2ea44f)](tests)
...
> **Now: v3.1.0** — full history in [CHANGELOG.md](CHANGELOG.md). Landing page: https://thejesh-k463.github.io/VYUHA-LOG/
>
...
tests/       2070 unit + integration tests across 138 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (2,070 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 2070 Vitest unit + integration tests (+ tests/load)
```
