...
[![Tests](https://img.shields.io/badge/tests-7019%20passing-2ea44f)](tests)
...
tests/       7019 unit + integration tests across 361 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7019 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7019 Vitest unit + integration tests (+ tests/load)
```
