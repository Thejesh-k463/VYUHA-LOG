...
[![Tests](https://img.shields.io/badge/tests-2288%20passing-2ea44f)](tests)
...
tests/       2288 unit + integration tests across 153 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (2,288 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 2288 Vitest unit + integration tests (+ tests/load)
```
