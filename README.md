...
[![Tests](https://img.shields.io/badge/tests-8644%20passing-2ea44f)](tests)
...
tests/       8644 unit + integration tests across 408 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (8644 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 8644 Vitest unit + integration tests (+ tests/load)
```
