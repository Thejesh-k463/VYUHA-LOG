...
[![Tests](https://img.shields.io/badge/tests-10932%20passing-2ea44f)](tests)
...
tests/       10932 unit + integration tests across 474 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (10932 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 10932 Vitest unit + integration tests (+ tests/load)
```
