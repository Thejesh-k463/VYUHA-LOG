...
[![Tests](https://img.shields.io/badge/tests-4506%20passing-2ea44f)](tests)
...
tests/       4506 unit + integration tests across 254 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (4506 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 4506 Vitest unit + integration tests (+ tests/load)
```
