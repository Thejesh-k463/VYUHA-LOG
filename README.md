...
[![Tests](https://img.shields.io/badge/tests-2109%20passing-2ea44f)](tests)
...
tests/       2109 unit + integration tests across 142 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (2,109 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 2109 Vitest unit + integration tests (+ tests/load)
```
