...
[![Tests](https://img.shields.io/badge/tests-6381%20passing-2ea44f)](tests)
...
> type yourself is that day's mark: the app does not overwrite it at the close,
> and typing after the close replaces the automatic one. Already-marked
...
tests/       6381 unit + integration tests across 341 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (6381 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 6381 Vitest unit + integration tests (+ tests/load)
```
