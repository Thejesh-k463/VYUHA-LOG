...
[![Tests](https://img.shields.io/badge/tests-1956%20passing-2ea44f)](tests)
...
tests/       1956 unit + integration tests across 133 files (+ tests/load: 14 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (1,956 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 1956 Vitest unit + integration tests (+ tests/load)
```
