...
[![Tests](https://img.shields.io/badge/tests-9526%20passing-2ea44f)](tests)
...
tests/       9526 unit + integration tests across 434 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (9526 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 9526 Vitest unit + integration tests (+ tests/load)
```
