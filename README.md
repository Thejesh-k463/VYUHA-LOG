...
[![Tests](https://img.shields.io/badge/tests-10967%20passing-2ea44f)](tests)
...
tests/       10967 unit + integration tests across 476 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (10967 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 10967 Vitest unit + integration tests (+ tests/load)
```
