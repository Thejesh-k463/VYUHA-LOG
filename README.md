...
[![Tests](https://img.shields.io/badge/tests-7882%20passing-2ea44f)](tests)
...
tests/       7882 unit + integration tests across 383 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7882 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7882 Vitest unit + integration tests (+ tests/load)
```
