...
[![Tests](https://img.shields.io/badge/tests-3825%20passing-2ea44f)](tests)
...
tests/       3825 unit + integration tests across 224 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (3,825 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 3825 Vitest unit + integration tests (+ tests/load)
```
