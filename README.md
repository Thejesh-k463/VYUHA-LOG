...
[![Tests](https://img.shields.io/badge/tests-11749%20passing-2ea44f)](tests)
...
tests/       11749 unit + integration tests across 495 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (11749 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 11749 Vitest unit + integration tests (+ tests/load)
```
