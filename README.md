...
[![Tests](https://img.shields.io/badge/tests-5185%20passing-2ea44f)](tests)
...
tests/       5185 unit + integration tests across 275 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (5185 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 5185 Vitest unit + integration tests (+ tests/load)
```
