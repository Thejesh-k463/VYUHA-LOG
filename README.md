...
[![Tests](https://img.shields.io/badge/tests-2184%20passing-2ea44f)](tests)
...
tests/       2184 unit + integration tests across 146 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (2,184 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 2184 Vitest unit + integration tests (+ tests/load)
```
