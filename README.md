...
[![Tests](https://img.shields.io/badge/tests-7031%20passing-2ea44f)](tests)
...
tests/       7031 unit + integration tests across 361 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (7031 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 7031 Vitest unit + integration tests (+ tests/load)
```
