...
[![Tests](https://img.shields.io/badge/tests-3434%20passing-2ea44f)](tests)
...
tests/       3434 unit + integration tests across 211 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (3,434 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 3434 Vitest unit + integration tests (+ tests/load)
```
