...
[![Tests](https://img.shields.io/badge/tests-8416%20passing-2ea44f)](tests)
...
tests/       8416 unit + integration tests across 397 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (8416 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 8416 Vitest unit + integration tests (+ tests/load)
```
