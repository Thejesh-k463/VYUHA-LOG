...
[![Tests](https://img.shields.io/badge/tests-8083%20passing-2ea44f)](tests)
...
tests/       8083 unit + integration tests across 389 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (8083 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 8083 Vitest unit + integration tests (+ tests/load)
```
