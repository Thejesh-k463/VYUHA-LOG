...
[![Tests](https://img.shields.io/badge/tests-2363%20passing-2ea44f)](tests)
...
tests/       2363 unit + integration tests across 157 files (+ tests/load: 15 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (2,363 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 2363 Vitest unit + integration tests (+ tests/load)
```
