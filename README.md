...
[![Tests](https://img.shields.io/badge/tests-8470%20passing-2ea44f)](tests)
...
tests/       8470 unit + integration tests across 398 files (+ tests/load: 16 load cases, run separately)
...
| `npm test` | Vitest unit + integration suite (8470 tests) |
...
VYUHA-LOG/
  ...
  tests/          # 8470 Vitest unit + integration tests (+ tests/load)
```
