...
const readme = [
  ...
  "This package contains no build source or vendor private keys. Signed licences deter sharing and machine-bound keys restrict normal use to one Windows installation. Like any offline desktop software, copying or reverse engineering cannot be made mathematically impossible.",
  "",
