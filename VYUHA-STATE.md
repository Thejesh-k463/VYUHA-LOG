...
4. Theme vs accent-skin — collapse into one list or keep both (§8.5). Q67's deferral "revisit v4.1" EXPIRED twice (v4.1 and v4.2 shipped); the backlog audit (`s8-product-ui.md`) recommends NOT collapsing — one word from you closes it either way (a later ruling subsumes the flag; this is the last time it is listed as open).
