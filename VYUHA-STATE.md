...
4. `AGENTS.md` before any code change (on conflict AGENTS.md wins over this file; the code wins over both) — it now has a "Bundled market calendar" section. Owner rulings: the spec's §0 table; `docs/DECISIONS.md` newest entries at the END (grep `^## 2026-09-2`, never read it whole — the newest is the 2026-09-25 W1 entry) — binding, never re-ask one.
