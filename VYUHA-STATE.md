...
## §0 START HERE — reconciled 2026-09-16 IST at `e23b96c` (fix wave 2M — the three guard findings, design-reviewed first, two seam rounds; CI 35022758611 SUCCESS 6/6) by the eighth session (the v4.3.0 fix work); the commit that landed this block is the next one in `git log`
...
**The one-line state (verified 2026-09-16 at `e23b96c`):** published release = **v4.2.0** (tag `9da7bc8` → `b488dde`).
...
- **Gate on `e23b96c`:** `npm run verify` — **427 files / 9,323 passed / 35 skipped** (the raw line; expected fail 0).
