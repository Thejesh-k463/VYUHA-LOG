...
3. Re-derive before asserting: `git log --oneline -3` · `git tag --sort=-creatordate | head -1` · `package.json` `"version"` (still 4.4.0) · `gh run list --limit 3` · the RAW vitest line (§0.3 V2).
