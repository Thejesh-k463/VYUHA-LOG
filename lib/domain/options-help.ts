...
/**
 * The chip on a beginner row — ONE word for both screens that print it (R52).
 * The /help card and the /strategies picker used to say "Beginner" and "basics"
 * for the same `beginner` flag; the picker reads it as `STRATEGY_COPY.beginner`.
 */
export const OPTIONS_BEGINNER_LABEL = "Beginner";
...
export const OPTIONS_HELP: OptionsHelpEntry[] = [
  {
    ...
    risk: "Time decay runs against a long option every day it is held, and the debit is gone in full if the underlying settles at or below K1. A long call left to settle in the money is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash). Far strikes are often thinly quoted.",
  ...
  },
  {
    ...
    risk: "Decay runs against the position daily and the debit is gone in full if the underlying settles at or above K1. A long put left to settle in the money is charged STT on intrinsic value, not on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash). Deep strikes can be hard to exit at a quoted price.",
  ...
  },
  {
    ...
    risk: "The premium is a repeated cost that reduces the net result every cycle it is renewed, and the floor lapses at expiry. An in-the-money long put left to settle is charged STT on intrinsic value, not on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "A short underlying leg brings borrowing and margin costs of its own, and the call premium is a repeated outlay against them. An in-the-money long call left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "An in-the-money short call settles at expiry, on a stock option by delivering the holding at K2, and both wings depend on strike liquidity. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "Both ends are bounded, so the short leg holds the result at K2 however far the move runs. Closing one leg alone leaves a naked short. An in-the-money long leg left to settle is charged STT on intrinsic value, not on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The wing caps the loss only while both legs are held together; unwinding one alone restores naked short risk. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "Both puts settle together at expiry, so a settle between the strikes leaves only the short put in the money, which on a stock option means delivery of the shares at K2. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The short leg holds the result at K1, and both legs settle together at expiry rather than one at a time. An in-the-money long leg left to settle is charged STT on intrinsic value, not on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "Both legs decay at once, so a quiet market costs the debit quickly, and a fall in implied volatility after an event can cost more than the move returns. An in-the-money long leg left to settle is charged STT on intrinsic value; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The distance between the strikes has to be crossed before anything comes back, and both legs decay together. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "Four legs mean four fills and four sets of charges, and a wing that cannot be filled leaves a naked short behind it. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The full credit is reached at one point only, and the body is in the money on one side almost always. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The peak is a single point, so the stated max profit is rarely reached in full, and three strikes mean three fills. A long wing left to settle in the money is charged STT on intrinsic value, which here can exceed the whole debit; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The same single-point peak as the call version, and three strikes mean three fills and three sets of charges. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The worst case sits where a quiet market most often settles, at the middle strike, and both wings are short. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "Four call legs at one expiry are four fills and four sets of charges, and the plateau is narrow in percentage terms. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The loss zone is the middle of the range, where a quiet market settles most often, and both outer legs are short. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "All four put legs settle together at expiry, so the structure stays whole only while every leg is held, and four legs are four fills. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The move has to clear an inner strike plus the debit before anything returns, and the full figure needs the outer strike. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The unhedged second short leg carries naked short risk above K2 and full margin with it, and a fast move through K2 is the worst case. An in-the-money long leg left to settle is charged STT on intrinsic value; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The second short put is unhedged below K1, and at expiry it settles in the money there, on a stock option as shares taken at K1 and still exposed to any further fall. An in-the-money long leg left to settle is charged STT on intrinsic value; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The worst case sits at the strike a drifting market reaches most easily, and two long legs decay against the position meanwhile. An in-the-money long leg left to settle is charged STT on intrinsic value; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "A slow drift into K1 is the worst outcome, and at expiry the short put settles in the money there, which on a stock option leaves a delivered position. An in-the-money long leg left to settle is charged STT on intrinsic value; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The result turns on implied volatility across two expiries, which an intrinsic-value payoff cannot show, and at the near expiry the short leg settles while the far leg stays open alone. An in-the-money long leg left to settle is charged STT on intrinsic value; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "A near put in the money at its expiry settles while the far put stays open (on a stock option, with delivered shares carried beside it), and the far leg's time value is invisible on the drawn curve. An in-the-money long leg left to settle is charged STT on intrinsic value; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    payoff:
      "The curve is drawn at the nearest expiry with the far leg at intrinsic, so max profit is Not computed. While the far leg is long, max loss is computed on that curve: the debit when the far strike is the nearer the money of the two, and the distance between the two strikes × quantity plus the debit when it is further out of the money, a credit subtracting. The breakevens describe the nearest expiry alone.",
    whoUses:
    ...
    risk: "The shape changes as the near leg rolls off, so what is on screen describes one expiry of a position that has two, and the far leg's time value is not in it. An in-the-money long leg left to settle is charged STT on intrinsic value; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The short put carries the whole downside and its margin, so this is not a limited-loss structure despite being built from options. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The short call is naked, so the upside has no bound and margin expands as volatility does. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    whoUses:
      "A trader who expects a directional move uses this directional shape; the range between the strikes is a flat band only when the call strike is above the put strike, and with the call strike below it both legs are in the money there.",
    risk: "The short leg is naked beyond its own strike and carries the same margin as an outright short option. An in-the-money long leg left to settle is charged STT on intrinsic value rather than on premium; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The whole result lives inside the fills and the charges — four legs, four spreads crossed — and a leg that cannot be filled breaks the flat payoff. Every in-the-money long leg left to settle is charged STT on intrinsic value, on both spreads at once; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "The downside is the short put's in full, unhedged all the way to the floor, and no institutional body publishes this name — it was coined on a trading desk. An in-the-money long leg left to settle is charged STT on intrinsic value; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "Three long premiums decay together, so the move has to be both large and quick, and no institutional body publishes these two names. An in-the-money long leg left to settle is charged STT on intrinsic value; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
  ...
  },
  {
    ...
    risk: "Both legs are in the money from the start, so both carry intrinsic value into settlement and in-the-money series are often thinly quoted. An in-the-money long leg left to settle is charged STT on intrinsic value — the charge long guts is most exposed to; a stock option settled by delivery is also charged the equity-delivery rate on the shares' strike value, on both sides (index options settle in cash).",
