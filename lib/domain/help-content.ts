...
export const HELP_ENTRIES: HelpEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The grouping, the payoff curve and the gross figures — labelled before charges — are free for every book, and the sixteen shapes Vyuha named before 4.3 keep their names on the free tier wherever the legs still form one of them: a holding of the underlying or a second expiry can turn the same legs into a covered call, a protective put, a collar, a calendar or a diagonal, and the free tier reads that book as its leg count. The other twenty-four names are part of Vyuha Pro: on the free tier a group matching one of them reads as its leg count rather than as a name. The shelf is Pro too — a selection of catalogue tiles pinned above the named groups, with undo, redo and restore-defaults — and so is the picker that edits it. Nothing here carries a name of your own: a shelf tile is a shape from the catalogue.",
