...
export const CATALOGUE: readonly StrategyDef[] = [
  ...
  // §4 row 18
  {
    ...
    breakevens: "K2 − credit/qty, K3 + credit/qty — each only on a side whose wing exceeds credit/qty",
  ...
  // §4 row 19
  {
    ...
    maxProfit: "credit",
    maxLoss: "max(K2−K1, K3−K2) × qty − credit",
    breakevens: "K2 ± credit/qty — each only on a side whose wing exceeds credit/qty",
  ...
  // §4 row 20
  {
    ...
    maxProfit: "(K2 − K1) × qty − debit (equal wings)",
    maxLoss: "debit (equal wings)",
  ...
  // §4 row 22 — one line, two shapes.
  {
    ...
    maxProfit: "credit (equal wings)",
    maxLoss: "(K2 − K1) × qty − credit (equal wings)",
  ...
  // §4 row 26
  {
    ...
    maxProfit: "max(K2−K1, K4−K3) × qty − debit",
    maxLoss: "debit",
    breakevens: "K2 − debit/qty, K3 + debit/qty — each only on a side whose wing exceeds debit/qty",
