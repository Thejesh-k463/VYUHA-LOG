...
import { metricDetail, metricCaveatLine } from "@/lib/domain/metric-help";
...
export default function ScalingPage() {
  ...
  <Card><CardHeader><CardTitle>Visual EOD replay</CardTitle></CardHeader><CardContent className="space-y-3"><p className="text-[0.6875rem] text-muted-foreground">{metricCaveatLine("replayEod")}</p><TradeReplay trades={replays}/></CardContent></Card></ProGate></div></>;
}
