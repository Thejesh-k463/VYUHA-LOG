      ...
      {p.tradingDays === 0 ? (
        ...
        <>
          ...
          <p className="border-t border-border pt-3 text-[10px] text-muted-foreground">
            ...
            {capitalKnown
              ? <>Time-weighted figures computed on running equity from configured capital; Sharpe/Sortino vs {Math.round(RISK_FREE * 100)}% risk-free, annualised over {annualisationNote(basis)}.</>
